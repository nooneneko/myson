package com.fixyou.myson.repository;

import com.fixyou.myson.MysonApp;
import com.fixyou.myson.config.Constants;
import com.fixyou.myson.config.audit.AuditEventConverter;
import com.fixyou.myson.domain.PersistentAuditEvent;
...
import static com.fixyou.myson.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
